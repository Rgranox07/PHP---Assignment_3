<!--Here I will add php to update the data-->
<?php
    include './database.php';
    $weddingObj = new database(); //Referencing the update function
                ...
                <form action="edit.php" method="post" class="form-containers">
                    ...
                    <div class="row mb-3">
                        <div class="d-flex justify-content-center mt-3">
                            <!--     As id should not be changed by user, it is given as hidden     -->
